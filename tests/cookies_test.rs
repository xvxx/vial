...
#[cfg(feature = "cookies")]
fn assign_only_once() {
    let request = Request::from_reader(File::open("tests/http/cookies_assign_only_once.txt").unwrap()).unwrap();
...
#[cfg(feature = "cookies")]
fn basic(){
    let request = Request::from_reader(File::open("tests/http/cookies_basic.txt").unwrap()).unwrap();
    assert_eq!("bar", request.cookie("foo").unwrap());
}
#[test]
#[cfg(feature = "cookies")]
fn escaping(){
    let request = Request::from_reader(File::open("tests/http/cookies_escaping.txt").unwrap()).unwrap();
    assert_eq!("bar=123456789&name=Magic+Mouse", request.cookie("foo").unwrap());
}
#[test]
#[cfg(feature = "cookies")]
fn ignore_escaping_error_and_return_orig_value(){
    let request = Request::from_reader(File::open("tests/http/cookies_ignore_escaping_error_and_return_orig_value.txt").unwrap()).unwrap();
    assert_eq!("%1", request.cookie("foo").unwrap());
    assert_eq!("bar", request.cookie("bar").unwrap());
}
#[test]
...
fn ignore_non_values(){
    let request = Request::from_reader(File::open("tests/http/cookies_ignore_non_values.txt").unwrap()).unwrap();
    assert_eq!("%1", request.cookie("foo").unwrap());
    assert_eq!("bar", request.cookie("bar").unwrap());
}
...
#[cfg(feature = "cookies")]
fn unencoded(){
    let request = Request::from_reader(File::open("tests/http/cookies_unencoded.txt").unwrap()).unwrap();
    assert_eq!("bar=123456789&name=Magic+Mouse", request.cookie("foo").unwrap());
}
#[test]
#[cfg(feature = "cookies")]
fn unencoded_2(){
    let request = Request::from_reader(File::open("tests/http/cookies_unencoded_2.txt").unwrap()).unwrap();
